#!/usr/bin/env python3
"""
Build the madgab English IPA corpus.
...
Run from the madgab repo root:

    corpus/venv/bin/python corpus/build.py

Writes data/common_ipa_transcriptions.json.
"""
...
SRC = ROOT / "sources"
OUT = ROOT.parent / "data" / "common_ipa_transcriptions.json"
